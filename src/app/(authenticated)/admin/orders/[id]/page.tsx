...
const Page = () => {
  ...
  } = api.transaction.getAdminOrder.useQuery(
    {
      id: Number(id),
    },
    {
          ...
          <div className="grid gap-3">
            ...
            <ul className="grid gap-3">
              <li className="flex items-center justify-between">
                ...
                <span>
                  {formatCurrency(transaction.order_details.sub_total)}
                </span>
              </li>
              <li className="flex items-center justify-between">
                <span className="text-muted-foreground">Delivery Fee</span>
                <span>
                  {formatCurrency(transaction.order_details.delivery_fee)}
                </span>
              </li>
              <li className="flex items-center justify-between font-semibold">
                ...
                <span>
                  {formatCurrency(
                    transaction.order_details.sub_total +
                      transaction.order_details.delivery_fee,
                  )}
                </span>
              </li>
            </ul>
              ...
              <div className="grid gap-3">
                ...
                <dl className="grid gap-3">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <dd>
                      <a href="tel:">
                        {transaction.delivery_info.contact_number}
                      </a>
                    </dd>
                  </div>
                </dl>
