...
const Page = () => {
    ...
    return (
        ...
        <div className="mx-auto grid w-full p-2">
            <ViewTransactionModal status={status} settings={settings} open={selectedTransaction} setOpen={setSelectedTransaction} setSelectedTransaction={setSelectedTransaction} />
                ...
                <Card x-chunk="dashboard-01-chunk-0" className=" bg-transparent border-none shadow-none">
                    ...
                    <div className=" relative rounded overflow-y-auto min-h-[300px] bg-white w-full grid mt-1" style={{ maxHeight: "80vh" }}>
                        ...
                        <div className=" flex flex-col gap-2 overflow-hidden">
                            {
                                status==="ONGOING" ? <PendingTables settings={settings} setSelectedTransaction={setSelectedTransaction} transactions={transactions}/> : 
                                status==="DONE" ? <DoneTable settings={settings} setSelectedTransaction={setSelectedTransaction} transactions={transactions}/> : 
                                <CancelledTable settings={settings} setSelectedTransaction={setSelectedTransaction} transactions={transactions}/>
                            }
                        </div>
                    </div>
                </Card>
