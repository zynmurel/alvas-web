...
const ForDelivery = () => {
    ...
    return (<div className=" relative rounded overflow-y-auto min-h-[200px] bg-white w-full grid" style={{ maxHeight: "80vh" }}>
        {
            (isLoadingForDelivery || settingsIsLoading) &&
        ...
        <div className=" flex flex-col overflow-y-auto" style={{maxHeight:"90vh"}}>
            {   
                data?.map((delivery)=>{
                    ...
                    return <div key={delivery.id} className=" p-2 px-4 rounded text-xs flex items-center flex-row border-b">
                    <div>
